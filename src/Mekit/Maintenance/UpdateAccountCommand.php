...
use Mekit\Maintenance\Account\AccountUpdater;
...
class UpdateAccountCommand extends Command implements CommandInterface
{
  const COMMAND_NAME = 'update:account';
  ...
  protected function execute(InputInterface $input, OutputInterface $output)
  {
    ...
    $fixer = new AccountUpdater([$this, 'log']);
