...
if(ACLController::checkAccess('mkt_AccountExtras', 'edit', true)){
    $module_menu[]=array('index.php?module=mkt_AccountExtras&action=EditView&return_module=mkt_AccountExtras&return_action=DetailView', $mod_strings['LNK_NEW_RECORD'], 'Add', 'mkt_AccountExtras');
}
