...
class mkt_AccountExtrasViewRawdata extends SugarView
{
  ...
  /*
   *
   *  ALTER TABLE mkt_accountextras MODIFY current_month MEDIUMTEXT;
      ALTER TABLE mkt_accountextras MODIFY deadlines MEDIUMTEXT;
      ALTER TABLE mkt_accountextras MODIFY products_recent_buys MEDIUMTEXT;
      ALTER TABLE mkt_accountextras MODIFY products_recent_non_buys MEDIUMTEXT;
      ALTER TABLE mkt_accountextras MODIFY client_data MEDIUMTEXT;
   *
   */
  ...
  protected function addToSmartyProducts($ss)
  {
    ...
    $this->debug["PRB_CODED_LENGHT"] = strlen($this->bean->products_recent_buys);
    $this->debug["PRB_DECODED_LENGHT"] = strlen(base64_decode($this->bean->products_recent_buys));

    //$this->debug["PNA"] = base64_decode($this->bean->products_recent_non_buys);
