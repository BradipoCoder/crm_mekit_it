...
<pre>
    EXTENDED OPTIONS: {$vardef.extended_options|@var_dump}
</pre>

{include file="modules/DynamicFields/templates/Fields/Forms/coreTop.tpl"}
<tr>
    <td class='mbLBL'>{sugar_translate module="DynamicFields" label="LBL_IMAGE_RESPONSIVE"}:</td>
    <td>
        <input type="checkbox" id ="responsive" name="responsive" value="1" {if !empty($vardef.extended_options.responsive)}checked{/if}/>
    </td>
</tr>
<tr>
