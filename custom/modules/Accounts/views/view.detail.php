...
class AccountsViewDetail extends ViewDetail {
     ...
     * @return bool|string
     */
    private function getAccountExtraIdForAccount($accountId)
    {
        $answer = false;
        ...
        $sql = "SELECT e.id FROM mkt_accountextras AS e WHERE e.account_id_c = '" . $accountId . "'";
        $res = $db->fetchOne($sql);
        //print($accountId . " - " . print_r($res, true));
