...
$admin_option_defs['Administration']['quickcrm_doc']= array('help','LBL_DOC_QUICKCRM_TITLE','LBL_DOC_QUICKCRM','https://www.quickcrm.fr/doc/mobile/latest/QuickCRM_Manual_english.htm?v=4.9.6');
$admin_option_defs['Administration']['quickcrm_devguide']= array('help','LBL_DEVGUIDE_QUICKCRM_TITLE','LBL_DEVGUIDE_QUICKCRM','https://www.quickcrm.fr/doc/mobile/latest/QuickCRM_Developers_Guide.pdf?v=4.9.6');
