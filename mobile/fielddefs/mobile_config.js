...
Beans['Accounts'].AdditionalFields = ['phone_office','phone_fax','website','email1','mkt_accountextras_accounts_name','vat_number_c','codice_fiscale_c','$ADDbilling','$ADDshipping','imp_agent_code_c','imp_ex_agent_code_c','industry','imp_status_c','imp_status_phase__c','imp_forced_status_c','ft_periodo_attuale_c','mesimobili12_c','dagenaoggi_c','ft_anno_meno_uno_completo_c','imp_profitability_c','ultimo_aggiornamento_c','credit_risk_c','importo_protesti_c','imp_client_yearly_revenue_c','imp_interest_articles_c','employee_number_c','imp_competitor_c','imp_other_competitor_c','imp_sync_as_client_c','imp_origin_c','imp_sync_as_supplier_c','imp_macchine_c','imp_macchine_proprieta_c','imp_macchine_note_c','macchine_ricordamelo_il_c','note_commerciali_nuovo_c'];
