...
QCRM.enableBeans(['Accounts','Contacts','Tasks','Calls','Meetings','Opportunities','Notes','Documents','Project','ProjectTask','Cases','mkt_Worklogs','Emails','AOS_Products','AOS_Quotes','AOR_Reports','AOS_Product_Categories','mkt_Inspection_Washing','AOK_KnowledgeBase','AOK_Knowledge_Base_Categories','mkt_AccountExtras','mkt_possibility']);
Beans['Accounts'].AdditionalFields = ['phone_office','phone_fax','website','email1','mkt_accountextras_accounts_name','vat_number_c','codice_fiscale_c','$ADDbilling','$ADDshipping','imp_agent_code_c','imp_ex_agent_code_c','industry','imp_status_c','imp_status_phase__c','imp_forced_status_c','ft_periodo_attuale_c','mesimobili12_c','dagenaoggi_c','ft_anno_meno_uno_completo_c','imp_profitability_c','ultimo_aggiornamento_c','credit_risk_c','andamentoreating_c','importo_protesti_c','imp_client_yearly_revenue_c','imp_interest_articles_c','employee_number_c','imp_competitor_c','imp_other_competitor_c','imp_sync_as_client_c','imp_origin_c','new_business_c','chiamatoperbarbara_c','note_commerciali_nuovo_c'];
Beans['Accounts'].SearchFields = ['imp_agent_code_c','imp_ex_agent_code_c','vat_number_c','imp_status_c','imp_status_phase__c','imp_forced_status_c','gv_cont_tot_c','gv_cont_meetings_c','ft_periodo_attuale_c','mesimobili12_c','dagenaoggi_c','ft_anno_meno_uno_completo_c','industry','zone_c','billing_address_street','billing_address_city','new_business_c','chiamatoperbarbara_c','affiancamento_c'];
Beans['Accounts'].CustomListFields = ['billing_address_city','billing_address_street','imp_status_phase__c','mesimobili12_c'];
Beans['Accounts'].CustomLinks = {'opportunities':{title:'Opportunities'},'mkt_possibility_accounts':{title:'mkt_possibility'},'calls':{title:'Calls'},'meetings':{title:'Meetings'},'tasks':{title:'Tasks'},'cases':{title:'Cases'},'project':{title:'Project'},'notes':{title:'Notes'},'documents':{title:'Documents'},'mkt_inspection_washing_accounts':{title:'mkt_Inspection_Washing'},'accounts_contacts_imp_dir':{title:'LBL_ACCOUNTS_CONTACTS_IMP_DIR_CONTACTS'},'accounts_contacts_imp_acq':{title:'LBL_ACCOUNTS_CONTACTS_IMP_ACQ_CONTACTS'},'accounts_contacts_imp_adm':{title:'LBL_ACCOUNTS_CONTACTS_IMP_ADM_CONTACTS'},'accounts_contacts_imp_com':{title:'LBL_ACCOUNTS_CONTACTS_IMP_COM_CONTACTS'},'accounts_contacts_imp_opr':{title:'LBL_ACCOUNTS_CONTACTS_IMP_OPR_CONTACTS'},'aos_quotes':{title:'AOS_Quotes'}};
...
Beans['Calls'].AdditionalFields = ['direction','status','result_c','date_start','duration_hours','duration_minutes','description','created_by_name','parent_name','assigned_user_name'];
...
Beans['Cases'].AdditionalFields = ['account_name','jjwg_maps_address_c','descrizione_problematica_c','date_close_prg_c','descrizione_aggiornamento_c','ref_part_number_c','ref_part_description_c','ref_part_unique_number_c','state','priority','type','internal_tag_number_c','rif_commessa_code_c','date_entered','date_close_efct_c','assigned_user_name'];
Beans['Cases'].SearchFields = ['type','date_close_prg_c','state','priority','descrizione_problematica_c','account_name','area_dinteresse_imp_c','date_close_efct_c','origine_c','rif_commessa_code_c','internal_tag_number_c','assigned_user_name'];
Beans['Cases'].CustomListFields = ['account_name','state','ref_part_description_c','descrizione_problematica_c'];
Beans['Cases'].CustomLinks = {'notes':{title:'Notes'},'cases_aos_quotes_1':{title:'AOS_Quotes'},'meetings':{title:'Meetings'},'tasks':{title:'Tasks'},'calls':{title:'Calls'},'users_cases_1users_ida':{title:'LBL_USERS_CASES_1_FROM_CASES_TITLE'}};
...
Beans['AOS_Quotes'].AdditionalFields = ['data_doc_c','quote_type','cases_aos_quotes_1_name','attivitagenerica_c','workhours_c','billing_account','machine_part_number_c','machine_name_c','machine_workhours_c','collaudo_c','controllisicurezza_c','ras_status_hint_c','discount_percent_c','opportunity','imp_agent_code_c','description','notes_internal_c','created_by_name','assigned_user_name'];
Beans['AOS_Quotes'].SearchFields = ['quote_type','document_year_c','document_number_c','data_doc_c','opportunity','billing_account','imp_agent_code_c','assigned_user_name'];
Beans['AOS_Quotes'].CustomListFields = ['quote_type','data_doc_c','billing_account','opportunity','cases_aos_quotes_1_name'];
Beans['AOS_Quotes'].CustomLinks = {'cases_aos_quotes_1':{title:'LBL_CASES_AOS_QUOTES_1_FROM_CASES_TITLE'},'aos_quotes_project':{title:'Project'},'aos_quotes_notes_1':{title:'Notes'}};
Beans['AOS_Quotes'].ColoredField = 'quote_type';
...
Beans['mkt_possibility'].AdditionalFields = ['description','stato_possibilita_c','mkt_possibility_accounts_name','assigned_user_name','trigger_date'];
Beans['mkt_possibility'].SearchFields = ['mkt_possibility_accounts_name','stato_possibilita_c','assigned_user_name','trigger_date'];
Beans['mkt_possibility'].CustomListFields = ['mkt_possibility_accounts_name','description','stato_possibilita_c'];
Beans['mkt_possibility'].CustomLinks = {'mkt_possibility_accounts':{title:'LBL_MKT_POSSIBILITY_ACCOUNTS_FROM_ACCOUNTS_TITLE'}};
