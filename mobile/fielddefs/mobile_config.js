...
Beans['Accounts'].SearchFields = ['imp_agent_code_c','imp_ex_agent_code_c','vat_number_c','imp_status_c','imp_status_phase__c','imp_forced_status_c','gv_cont_tot_c','gv_cont_meetings_c','ft_periodo_attuale_c','mesimobili12_c','dagenaoggi_c','ft_anno_meno_uno_completo_c','zone_c','industry','billing_address_street','billing_address_city','affiancamento_c'];
