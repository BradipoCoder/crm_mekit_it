...
Beans['Cases'].CustomLinks = {'notes':{title:'Notes'},'tasks':{title:'Tasks'},'meetings':{title:'Meetings'},'calls':{title:'Calls'},'contacts':{title:'Contacts'}};
...
Beans['AOS_Quotes'].AdditionalFields = ['data_doc_c','billing_account','discount_percent_c','opportunity','imp_agent_code_c'];
